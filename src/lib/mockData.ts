...
export const lessons: Lesson[] = [
  ...
  { day: 'Mo', period: 3, subject: 'Deutsch', subjectShort: 'DEU', teacher: 'Herr Schneider', room: 'R203', color: 'red' },
  { day: 'Mo', period: 4, subject: 'Deutsch', subjectShort: 'DEU', teacher: 'Herr Schneider', room: 'R203', color: 'red' },
  { day: 'Mo', period: 5, subject: 'Sport', subjectShort: 'SPO', teacher: 'Herr Koch', room: 'Sporthalle', color: 'violet' },
  { day: 'Mo', period: 6, subject: 'Sport', subjectShort: 'SPO', teacher: 'Herr Koch', room: 'Sporthalle', color: 'violet' },
  // Dienstag
  { day: 'Di', period: 1, subject: 'Englisch', subjectShort: 'ENG', teacher: 'Frau Müller', room: 'R105', color: 'yellow' },
  { day: 'Di', period: 2, subject: 'Englisch', subjectShort: 'ENG', teacher: 'Frau Müller', room: 'R105', color: 'yellow' },
  { day: 'Di', period: 3, subject: 'Physik', subjectShort: 'PHY', teacher: 'Herr Braun', room: 'R301', color: 'emerald' },
  { day: 'Di', period: 4, subject: 'Physik', subjectShort: 'PHY', teacher: 'Herr Braun', room: 'R301', color: 'emerald' },
  { day: 'Di', period: 5, subject: 'Geschichte', subjectShort: 'GES', teacher: 'Frau Fischer', room: 'R208', color: 'orange' },
  { day: 'Di', period: 6, subject: 'Geschichte', subjectShort: 'GES', teacher: 'Frau Fischer', room: 'R208', color: 'orange' },
  ...
  { day: 'Mi', period: 3, subject: 'Deutsch', subjectShort: 'DEU', teacher: 'Herr Schneider', room: 'R203', color: 'red' },
  { day: 'Mi', period: 4, subject: 'Kunst', subjectShort: 'KUN', teacher: 'Frau Lange', room: 'Kunstraum', color: 'stone' },
  { day: 'Mi', period: 5, subject: 'Englisch', subjectShort: 'ENG', teacher: 'Frau Müller', room: 'R105', color: 'yellow' },
  { day: 'Mi', period: 6, subject: 'Englisch', subjectShort: 'ENG', teacher: 'Frau Müller', room: 'R105', color: 'yellow' },
  // Donnerstag
  { day: 'Do', period: 1, subject: 'Physik', subjectShort: 'PHY', teacher: 'Herr Braun', room: 'R301', color: 'emerald' },
  { day: 'Do', period: 2, subject: 'Geschichte', subjectShort: 'GES', teacher: 'Frau Fischer', room: 'R208', color: 'orange' },
  ...
  { day: 'Do', period: 6, subject: 'Deutsch', subjectShort: 'DEU', teacher: 'Herr Schneider', room: 'R203', color: 'red' },
  { day: 'Do', period: 7, subject: 'Kunst', subjectShort: 'KUN', teacher: 'Frau Lange', room: 'Kunstraum', color: 'stone' },
  // Freitag
  { day: 'Fr', period: 1, subject: 'Englisch', subjectShort: 'ENG', teacher: 'Frau Müller', room: 'R105', color: 'yellow' },
  { day: 'Fr', period: 2, subject: 'Geschichte', subjectShort: 'GES', teacher: 'Frau Fischer', room: 'R208', color: 'orange' },
  { day: 'Fr', period: 3, subject: 'Sport', subjectShort: 'SPO', teacher: 'Herr Koch', room: 'Sporthalle', color: 'violet' },
  { day: 'Fr', period: 4, subject: 'Sport', subjectShort: 'SPO', teacher: 'Herr Koch', room: 'Sporthalle', color: 'violet' },
  { day: 'Fr', period: 5, subject: 'Physik', subjectShort: 'PHY', teacher: 'Herr Braun', room: 'R301', color: 'emerald' },
];
